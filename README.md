...
Willkommen bei Programmieren 2! Das hier ist die erste Aufgabe zum Aufwärmen. Forken Sie bitte das Aufgaben-Repository, lesen Sie  die JavaDoc zum Test für ```calculateBabylonianRoot``` durch und implementieren Sie ```calculateBabylonianRoot``` entsprechend. 
